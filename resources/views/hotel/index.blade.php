    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-100">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">🔐 Hotels</h2>
                    ...
                    <table class="w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        @forelse ($hotels as $hotel)
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 font-medium text-gray-800">{{ $hotel->id }}</td>
                                <td class="px-6 py-4 text-gray-700">{{ $hotel->name }}</td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-3">
                                        @can('edit permission')
                                            <a href="{{ route('permission.edit', $hotel->id) }}"
                                        ...
                                        @can('delete permission')
                                            <a href="{{ route('permission.delete', $hotel->id) }}"
