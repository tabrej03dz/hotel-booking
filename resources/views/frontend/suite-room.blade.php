                ...
                <div class="w-full lg:w-1/2 space-y-8">
                    ...
                    <div class="space-y-6">
                        <p class="text-lg text-gray-700 leading-relaxed">
                            Welcome to the Suite Room designed to offer the perfect blend of sophistication, comfort and
                            personalized service. Whether you're traveling for business or leisure, our suite ensures a
                            memorable stay with premium amenities and refined interiors.
                        </p>
                        <p class="text-lg text-gray-700 leading-relaxed">
                            Redefining modern rooms, it offers unmatched comfort and outstanding value, representing the
                            pinnacle of contemporary sophistication.
                        </p>
                            ...
                            <div id="galleryModal"
                                ...
                                <div
                                    ...
                                    <div class="p-6 sm:p-10">
                                        <h2 class="text-3xl font-bold text-center text-[#8B4513] mb-6">Our Suite Rooms
                                        </h2>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                            ...
                                            <div
                                                ...
                                                <img src="{{ asset('asset/images/Suite1.jpg') }}" alt="Luxury Room 1"
                                            ...
                                            <div
                                                class="rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                                                <img src="{{ asset('asset/images/Suite2.jpg') }}" alt="Luxury Room 3"
                                                    class="w-full h-64 object-cover">
                                            </div>
                                            <div
                                                class="rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                                                <img src="{{ asset('asset/images/suite5.jpg') }}" alt="Luxury Room 4"
                                                    class="w-full h-64 object-cover">
                                            </div>
                                            <div
                                                class="rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                                                <img src="{{ asset('asset/images/suite4.jpg') }}" alt="Luxury Room 5"
                                                    class="w-full h-64 object-cover">
                                            </div>
                                            <div
                                                class="rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                                                <img src="{{ asset('asset/images/suite3.jpg') }}" alt="Luxury Room 6"
                                                    class="w-full h-64 object-cover">
                                            </div>
                                        </div>
                                    </div>
