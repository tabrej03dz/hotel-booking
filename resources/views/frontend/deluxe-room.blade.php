    ...
    <section class="relative py-32 overflow-hidden bg-gradient-to-b from-white to-gray-50">+
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="swiper luxury-slider relative">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('asset/deluxe/deluxe-3.jpg') }}" alt="Hotel Detail 1"
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('asset/deluxe/deluxe-1.jpg') }}" alt="Hotel Detail 6"
                                    class="w-full h-[500px] object-cover" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-6 py-12">
                <h1 class="text-3xl text-gray-800">The Deluxe room has all the essential conveniences and is tastefully
