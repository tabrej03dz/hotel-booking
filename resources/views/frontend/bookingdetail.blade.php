          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <input type="date" class="font-bold text-gray-900" name="check_in_date" value="{{$checkInDate}}" readonly/>
            ...
            <div>
              ...
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <input type="date" class="font-bold text-gray-900" name="check_out_date" value="{{$checkOutDate}}" readonly/>
...
{{--          </div>--}}
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 h-fit sticky top-6">
          ...
          @php
              $price = ($room->discounted_price ?? $room->price) ?? ($room->roomType->discounted_price ?? $room->roomType->price) * $days;
              $tax = ($price * 18)/100;
          @endphp
          <div class="space-y-4">
          ...
          <button type="submit" class="mt-8 w-full bg-gradient-to-r from-amber-600 to-amber-700 text-white font-bold py-3 px-6 rounded-lg hover:from-amber-700 hover:to-amber-800 transition-all duration-300 shadow-md">
            Confirm Booking
          </button>
