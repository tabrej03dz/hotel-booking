...
<head>
    ...
    <style>
        ...
        .logo-box img {
            width: 180px;     /* change size if needed */
            object-fit: contain;
        }
        ...
        .grid-2 { display: flex; justify-content: space-between; flex-wrap: wrap; }
        .grid-col { width: 48%; }
        ...
        .table .total-row { font-weight: bold; background-color: #f1f5f9; }
...
<div class="container">
    ...
    <!-- ⭐ LOGO TOP CENTER ⭐ -->
    <div class="logo-box">
        <img src="{{ url('asset/LOGOWS.jpg') }}" width="180" alt="Logo">
    </div>

    <h1 class="text-xl text-center">Hotelier Voucher</h1>
    <div class="mb-3 text-sm font-semibold text-center">VoucherHotelier</div>
    ...
    <div class="grid-2 mb-4">
        ...
        <div class="grid-col">
            ...
            <p class="mt-2">
                <strong>TOTAL GUEST(S)</strong>: {{ $booking->adults }} Adults
